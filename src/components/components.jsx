...
// import engagementDay from "../assets/engagement_day.png";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            style={{ width: "100px", height: "2px", background: "goldenrod" }}
          />
          <div>ថ្ងៃ ចន្ទ</div>
          <div
            style={{ width: "100px", height: "2px", background: "goldenrod" }}
...
export function CountdownImage({ targetDate }) {
  ...
  return (
    ...
    >
      ...
      {/* Countdown overlay */}
      <div
        className={`countdown-box ${isFinished ? "finished-animation" : ""}`}
      >
        {isFinished ? (
